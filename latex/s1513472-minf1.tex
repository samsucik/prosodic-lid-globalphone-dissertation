...
\chapter{Data}{
  ...
  \section{Data preprocessing}{
    ...
    \textbf{Splitting longer utterances into shorter segments} was done to match the setup used by \citet{Snyder_et_al_2018}: Enrollment set utterances were split into 
    
    % compute VAD (used across all experiments) from MFCC feats (based on C0) % this was a mistake; VAD should've been computed based on energy, not on C0
