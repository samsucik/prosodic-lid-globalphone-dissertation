...
\chapter{Background}{
  ...
  \section{Features used in language identification}{
    ...
    \subsection{Acoustic features}{
      ...
      As with standard deltas, capturing long-range trends with SDCs can certainly be beneficial for i-vector systems (examples of SDC use include \cite{Ferrer_et_al_2016} and \cite{Sarma_et_al_2018}, the later reporting better results compared to using high-resolution MFCCs). However, its usefulness is not so clear in architectures inherently able to extracting temporal trends.
    ...
    \subsection{Prosodic features}{
      ...
      % stress+rhythm => stress-timed/syllable-timed/mora-timed

      % duration of syllable: some 100-200 ms (https://core.ac.uk/download/pdf/84560.pdf)
      % TO-DO: comment on temporal ranges? 15 frames cover variation across maybe 1-2 syllables
      ...
      TO-DO: make it clear that C0 is still used!
