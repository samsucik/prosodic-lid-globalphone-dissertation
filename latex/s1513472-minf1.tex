...
\chapter{Implementation}{
  ...
  \section{Kaldi recipes used in this work}{
    ...
    % no existing recipe corresponding to \cite{Snyder_et_al_2018}, but the x-vector TDNN was the same as for SRE. further info from the LID was used to replicate the system used there as closely as possible (except for the classifier)
