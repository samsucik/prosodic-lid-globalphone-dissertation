...
\chapter{Implementation}{
  ...
  \section{Choice of classifier}{
    ...
    % \citet{Martinez_et_al_2011} compare LR with SVM (LR slightly better)
    % LR worse than GMM because cannot do out-of-set rejection (as pointed out by \citet{McCree_2014})
    % \citet{Plchot_et_al_2016} use linear Gaussian classifier
    % \cite{Snyder_et_al_2018}, for instance, used GMM trained using MMI -- based on \cite{McCree_2014}.
    ...
    whitening or dimensionality reduction is not performed (length normalisation was done!)
