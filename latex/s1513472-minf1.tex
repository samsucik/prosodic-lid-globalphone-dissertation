...
\chapter{Background}{
  ...
  \section{Features used in language identification}{
    ...
    \subsection{Acoustic features}{
      ...
      % diagram of SDCs
      % Advantage of acoustic features for LID: where LID is part of ASD, acoustic feats are available anyway, hence there's no need to compute different feats just for the LID part.
